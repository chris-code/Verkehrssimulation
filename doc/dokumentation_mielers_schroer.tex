...
Bevor die Simulation gestartet werden kann, muss die Autobahn initialisiert werden. Dabei können wahlweise Fahrzeuge auf der Autobahn platziert werden oder nicht. Bei periodischen Randbedingungen werden während der Simualtion keine neuen Fahrzeuge erzeugt, hier ist es also hochgradig sinnvoll bei der Initailiserung Fahrzeuge auf der Autobahn zu platzieren. Diese gehen während der Simulation nicht verloren. Ohne periodische Randbedingungen werden in jedem Simulationsschritt mit einer gewissen Wahrscheinlichkeit neue Fahrzeuge erzeugt. In der Initialisierung Fahrzeuge zu erzeugen, ist in diesem Fall nicht notwendig, aber dennoch möglich.
...
Neue Fahrzeuge werden nur dann hinzugefügt, wenn keine periodischen Randbedingungen gelten. 
